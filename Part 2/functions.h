 ...
 *
 * Arguments:
 * *list_heads: a pointer to the track list head and stop list head
 *
 * Possible Errors:
...
/*
 * Clears everything and frees all the memory allocated
 * 
 * Arguments:
 * *list_heads: a pointer to the track list head and stop list head
 */
...
/*
 * Lists the intersections between tracks
 */
void i_command();
...
/*
 * Removes a track from a stop's list of tracks
 * 
 * Arguments:
 ...
 *
 * Return value:
 * 1 if successfully removes, 0 otherwise
 */
size_t remove_track_name(char *name, track_name_list_t *name_list_head);
