...
Este repositório git pertence a ist195817 e destina-se ao project1 de iaed-23.


O enunciado do projecto está disponível em [enunciado.md](enunciado.md).


Os alunos devem submeter aqui a sua solução para o project1 que será avaliada automaticamente.
...
```
gcc -O3 -Wall -Wextra -Werror -ansi -pedantic -lm *.c -o proj1 
```
